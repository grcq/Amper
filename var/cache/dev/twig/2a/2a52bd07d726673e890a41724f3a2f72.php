...
class __TwigTemplate_2e7ec049a228edd6d8011759e6f46065 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "
    <br>
    <p style=\"font-size: 20px;\">Logged in as <strong>";
        // line 9
        echo twig_escape_filter($this->env, (isset($context["username"]) || array_key_exists("username", $context) ? $context["username"] : (function () { throw new RuntimeError('Variable "username" does not exist.', 9, $this->source); })()), "html", null, true);
        echo "</strong></p>
";
    ...
    {
        return array (  98 => 5,  88 => 4,  76 => 9,  72 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    ...
    <br>
    <p style=\"font-size: 20px;\">Logged in as <strong>{{username}}</strong></p>
{% endblock %}
", "admin/dashboard.html.twig", "/var/www/dev/templates/admin/dashboard.html.twig");
    }
}
