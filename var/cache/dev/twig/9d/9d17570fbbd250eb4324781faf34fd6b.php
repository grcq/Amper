...
class __TwigTemplate_902fe73b1229394c4d1ec399d16c07ad extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("@!EasyAdmin/layout.html.twig", "category/new.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 10
        echo "
    <form method=\"POST\" action=\"/dashboard?menuIndex=2&routeName=app_category_new&submenuIndex=-1\">
        <label for=\"name\">Name</label>
        <br>
        <input type=\"text\" name=\"name\" id=\"name\" style=\"width: 20em;\" placeholder=\"Name\" />
        <br>
        <br>
        <label for=\"domain\">Domain</label>
        <br>
        <input type=\"text\" name=\"domain\" id=\"domain\" style=\"width: 20em;\" placeholder=\"Domain\" />
        <br>
...
";
    ...
    {
        return array (  138 => 7,  128 => 6,  116 => 29,  108 => 24,  92 => 10,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
...
{% block content %}
    ...
    <form method=\"POST\" action=\"/dashboard?menuIndex=2&routeName=app_category_new&submenuIndex=-1\">
        ...
        <br>
        <br>
        <button name=\"btn\" class=\"btn\">{{ button_label|default('Save') }}</button>
        <br>
    </form>
...
{% endblock %}
", "category/new.html.twig", "/var/www/dev/templates/category/new.html.twig");
    }
}
