 ...
 */
class getRouting_LoaderService extends App_KernelAmperDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'amper');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'amper'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'amper'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'amper'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'amper'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'amper'));
